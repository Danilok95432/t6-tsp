...
import { RepeatSupportRequestModal } from '../repeat-support-request-modal/repeat-support-request-modal'
...
export const ResponseSupportModal = () => {
	...
	const onSubmit: SubmitHandler<ResponseInputs> = (data) => {
		const formData = {
			...data,
			rating: starRating, // Добавляем рейтинг к данным формы
		}
					...
					<form onSubmit={methods.handleSubmit(onSubmit)} noValidate>
						...
						<p className={styles.reject}>
							...
							<AdminButton
								...
								onClick={() => openModal(<RepeatSupportRequestModal />)}
							>
								Создать повторное обращение
							</AdminButton>
						</p>
					</form>
				</FormProvider>
