...
export const AdminSettings: FC = () => {
	...
	const onSubmit: SubmitHandler<SettingsInputs> = async (data) => {
		...
		formData.append('use_big', booleanToNumberString(data.use_big))
		formData.append('use_small', booleanToNumberString(data.use_small))
		formData.append('use_projects', booleanToNumberString(data.use_projects))
		formData.append('use_prof', booleanToNumberString(data.use_prof))
		formData.append('use_docs', booleanToNumberString(data.use_docs))
		formData.append('use_contacts', booleanToNumberString(data.use_contacts))
